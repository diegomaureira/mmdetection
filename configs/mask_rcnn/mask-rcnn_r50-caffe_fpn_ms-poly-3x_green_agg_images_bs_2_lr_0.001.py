...
visualizer = dict(
    ...
    vis_backends=[
        dict(
            save_dir=
            '/mt/sdb/TrainCell/work_dirs/green_agg_images_exps_v1/mask-rcnn_r50-caffe_fpn_ms-poly-3x_green_agg_images_bs_2_lr_0.001',
        ...
        dict(
            init_kwargs=dict(
                group='maskrcnn-r50',
                name=
                'mask-rcnn_r50-caffe_fpn_ms-poly-3x_green_agg_images_bs_2_lr_0.001',
                project='green_agg_images_exps_v1'),
            type='WandbVisBackend'),
    ])
work_dir = '/mt/sdb/TrainCell/work_dirs/green_agg_images_exps_v1/mask-rcnn_r50-caffe_fpn_ms-poly-3x_green_agg_images_bs_2_lr_0.001'
