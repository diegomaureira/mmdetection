...
visualizer = dict(
    ...
    vis_backends=[
        dict(
            save_dir=
            '/mt/sdb/TrainCell/work_dirs/green_agg_images_exps_v1/mask2former_swin-t_green_agg_images_iters-368750_lr-0.0001_rf_rc_pmd_co_cp_512x512',
        ...
        dict(
            init_kwargs=dict(
                ...
                name=
                'mask2former_swin-t_green_agg_images_iters-368750_lr-0.0001_rf_rc_pmd_co_cp_512x512',
                project='green_agg_images_exps_v1'),
            type='WandbVisBackend'),
    ])
work_dir = '/mt/sdb/TrainCell/work_dirs/green_agg_images_exps_v1/mask2former_swin-t_green_agg_images_iters-368750_lr-0.0001_rf_rc_pmd_co_cp_512x512'
